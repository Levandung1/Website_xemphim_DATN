    ...
    return (
        <>
            ...
            <button
                ...
                className="fixed bottom-6 right-6 bg-red-600 text-white p-4 rounded-full shadow-xl hover:scale-110 transition-transform z-50"
            >
                <svg
          ...
          backdrop-blur-xl border border-white/20 animate-fadeIn z-50
        ">
                    {/* HEADER */}
