    ...
    return (
        <>
            ...
            <button
                ...
                className="absolute bottom-6 right-6 z-50 w-14 h-14 rounded-full bg-gradient-to-br from-red-600 to-red-800 "
            >
            ...
            {open && (
                <div
                    className="absolute bottom-[96px] right-6 z-50w-[360px] h-[520px] " >
                    {/* HEADER */}
                    ...
                    ${msg.sender === "user"
                        ...
                        {isTyping && (
                            <div className="flex justify-start">
                                <div className="bg-[#1f1f1f] text-gray-300 px-4 py-2 rounded-2xl rounded-bl-md text-sm animate-pulse">
                                    Đang soạn...
                                </div>
                            </div>
                        )}
