...
const API_URL = "http://localhost:5000/api/admin/comments"; // ⚡ chỉnh theo server của bạn
        ...
        <tbody>
          {comments.map((c) => (
            <tr key={c._id}>
              ...
              <Td>{c.userId?.username || c.userName || "Unknown"}</Td>

              <Td>{c.movieId?.title || "Unknown"}</Td>
              ...
              <Td>
                <ActionButton onClick={() => handleDelete(c._id)}>
                  Xoá
                </ActionButton>
              </Td>
            </tr>
